...
locus_zoom_region_temp <- function(gwas_res, CHR, start, stop, rdir=".", sig_line1=7.3, sig_line2=5, clean=FALSE) {
  ...
  if(!dir.exists(paste(rdir, "/locuszoom/", sep=""))) {
